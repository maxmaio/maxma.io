...
class art3 extends React.Component {
    componentDidMount() {
      this.drawArt();
    }
...
drawArt(){
	const canvas = {
		init() {
            ...
            if(canvasSize<500){
                this.elem.width = "800";
                this.elem.height = "1200";
            }
            else{
                this.elem.width = "1800";
    ...
    document.getElementById('canvas3').style.width =stringWidth;
    document.getElementById('canvas3').style.height =stringHeight;
	//////////////////////////////////////////////////////
	const run = () => {
